...
import 'package:kitap_arkadasligi/src/modules/auth/register_mail/bloc/register_mail_bloc.dart';
...
class _RegisterMailScreenState extends State<RegisterMailScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => RegisterMailBloc()..add(StartEvent()),
      child: BlocConsumer<RegisterMailBloc, RegisterMailState>(
